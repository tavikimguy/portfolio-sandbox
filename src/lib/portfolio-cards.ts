...
export interface FolderItem {
  ...
  poster?: string;
  // Copy lifted verbatim from tavi.kim. On a media item it's the caption
  // for that asset; on a `text` item it's the whole body.
  body?: string;
}
...
export const PORTFOLIO_CARDS: PortfolioCard[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'golden-thread',
        label: 'UI Design · The Golden Thread',
        kind: 'image',
    ...
    items: [
      {
        ...
        body: 'Rebranding my favorite campus food truck.',
      },
    ],
  },
  {
    ...
    link: 'https://www.tavi.kim/',
    items: [
      { id: 'pink-hat', label: 'Pink Hat', kind: 'image', src: '/assets/shared/painting-pink-hat-original.jpg' },
      { id: 'cowboy', label: 'Cowboy Portrait', kind: 'image', src: '/assets/home/painting-cowboy-portrait.jpg' },
      { id: 'masked-figure', label: 'Masked Figure', kind: 'image', src: '/assets/home/painting-masked-figure.webp' },
      { id: 'yellow-face', label: 'Yellow Face', kind: 'image', src: '/assets/home/painting-yellow-face.webp' },
      { id: 'hand-and-cloth', label: 'Hand and Cloth', kind: 'image', src: '/assets/home/painting-hand-and-cloth.webp' },
      { id: 'figure-with-melon', label: 'Figure with Melon', kind: 'image', src: '/assets/home/painting-figure-with-melon.webp' },
      { id: 'fist-and-face', label: 'Fist and Face', kind: 'image', src: '/assets/home/painting-fist-and-face.jpg' },
      { id: 'child-in-red-trees', label: 'Child in Red Trees', kind: 'image', src: '/assets/home/painting-child-in-red-trees.jpg' },
      { id: 'blue-hands', label: 'Blue Hands', kind: 'image', src: '/assets/home/painting-blue-hands.jpg' },
      { id: 'i-love-mommy', label: 'I Love Mommy', kind: 'image', src: '/assets/home/painting-i-love-mommy.jpg' },
    ],
  },
  {
    id: 'sprint',
    ...
    items: [
      {
        ...
        body: 'A zine made for my 24th birthday. Tavi Kim — New York, 2025.',
      },
    ],
  },
];
