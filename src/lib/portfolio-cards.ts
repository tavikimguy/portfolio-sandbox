...
export interface FolderItem {
  ...
  body?: string;
  // Burst size, fitted to the asset's real aspect ratio inside ITEM_BOX so
  // nothing gets letterboxed or cropped on the way out. Canvas.tsx falls
  // back to TEXT_ITEM_* when these are absent.
  width?: number;
  height?: number;
}
...
export const PORTFOLIO_CARDS: PortfolioCard[] = [
  {
    ...
    items: [
      ...
      { id: 'user-insight', label: 'User Insight', kind: 'image', src: '/assets/pieces/user-insight.png', width: 380, height: 214 },
      {
        id: 'wireframe-note',
        label: 'Wireframing',
        kind: 'text',
      ...
      { id: 'wireframes', label: 'Wireframes', kind: 'image', src: '/assets/pieces/wireframes.png', width: 380, height: 214 },
      {
        id: 'hifi-note',
      ...
      { id: 'hifi-designs', label: 'Hi-Fi Designs', kind: 'image', src: '/assets/pieces/hifi-designs.png', width: 380, height: 214 },
      {
        id: 'app-mockup',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'motion-ehr', label: 'EHR Workflow', kind: 'video', src: '/assets/blueprint/ehr-workflow-promo.mp4', width: 380, height: 380 },
      {
        id: 'motion-soap',
      ...
      { id: 'motion-copy-note', label: 'Copy Note to EHR', kind: 'video', src: '/assets/blueprint/copy-note-to-ehr.mp4', width: 380, height: 214 },
      {
        id: 'ui-note',
        label: 'UI Design',
        kind: 'text',
      ...
      { id: 'golden-thread', label: 'The Golden Thread', kind: 'image', src: '/assets/blueprint/golden-thread-blog.png', width: 380, height: 238 },
      {
        id: 'between-sessions',
      ...
      { id: 'session-prep', label: 'Session Prep', kind: 'image', src: '/assets/home/blueprint-session-prep.png', width: 380, height: 238 },
      {
        id: 'social-note',
      ...
      { id: 'social', label: 'Social Deliverables', kind: 'image', src: '/assets/blueprint/social-deliverables.png', width: 380, height: 214 },
      {
        id: 'ocean',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'user-research', label: 'User Research', kind: 'image', src: '/assets/flipkit/user-research.png', width: 380, height: 214 },
      { id: 'problems', label: 'Problems', kind: 'image', src: '/assets/flipkit/problems.png', width: 380, height: 214 },
      {
        id: 'flow-note',
        label: 'User Flow',
        kind: 'text',
      ...
      { id: 'user-flow', label: 'User Flow Map', kind: 'image', src: '/assets/flipkit/user-flow-map.png', width: 380, height: 214 },
      { id: 'lofi', label: 'Early Ideation and Lo-Fi', kind: 'image', src: '/assets/flipkit/lofi-designs.png', width: 380, height: 214 },
      {
        id: 'delivery-note',
      ...
      { id: 'dashboard', label: 'Dashboard', kind: 'image', src: '/assets/flipkit/dashboard-home.png', width: 380, height: 204 },
      { id: 'app-screens', label: 'App Screens', kind: 'video', src: '/assets/home/flipkit-app-screens.mp4', width: 380, height: 214 },
      { id: 'web-dashboard', label: 'Web Dashboard', kind: 'video', src: '/assets/home/flipkit-web-dashboard.mp4', width: 380, height: 380 },
      {
        id: 'brand',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'logo-3d', label: '3D Logo Variations', kind: 'image', src: '/assets/wfoc/logo-3d-variations.png', width: 380, height: 214 },
      { id: 'logo-animation', label: 'Logo Animation', kind: 'video', src: '/assets/shared/wfoc-logo-animation.mp4', width: 380, height: 214 },
      {
        id: 'mark-note',
        label: 'The Flat Mark',
        kind: 'text',
      ...
      { id: 'logo-mark', label: 'Logo Mark', kind: 'image', src: '/assets/wfoc/logo-mark.png', width: 380, height: 214 },
      {
        id: 'type-note',
      ...
      { id: 'merchandise', label: 'Merchandise', kind: 'image', src: '/assets/wfoc/merchandise.png', width: 380, height: 214 },
      { id: 'print-posters', label: 'Print Posters', kind: 'image', src: '/assets/wfoc/print-posters.png', width: 380, height: 214 },
      { id: 'social', label: 'Social Deliverables', kind: 'image', src: '/assets/wfoc/social-deliverables.png', width: 380, height: 214 },
      {
        id: 'ocean',
        label: 'Background Footage',
        kind: 'video',
  ...
  // expect significant changes.
  {
    ...
    items: [
      { id: 'truck', label: 'Don Memo', kind: 'image', src: '/assets/home/photo-food-truck.jpg', width: 380, height: 285 },
  ...
  },
  {
    ...
    link: 'https://www.tavi.kim/',
    items: [
      { id: 'pink-hat', label: 'Pink Hat', kind: 'image', src: '/assets/shared/painting-pink-hat-original.jpg', width: 380, height: 370 },
      { id: 'cowboy', label: 'Cowboy Portrait', kind: 'image', src: '/assets/home/painting-cowboy-portrait.jpg', width: 286, height: 380 },
      { id: 'masked-figure', label: 'Masked Figure', kind: 'image', src: '/assets/home/painting-masked-figure.webp', width: 380, height: 380 },
      { id: 'yellow-face', label: 'Yellow Face', kind: 'image', src: '/assets/home/painting-yellow-face.webp', width: 380, height: 380 },
      { id: 'hand-and-cloth', label: 'Hand and Cloth', kind: 'image', src: '/assets/home/painting-hand-and-cloth.webp', width: 380, height: 380 },
      {
      ...
      { id: 'fist-and-face', label: 'Fist and Face', kind: 'image', src: '/assets/home/painting-fist-and-face.jpg', width: 375, height: 380 },
      {
      ...
      { id: 'blue-hands', label: 'Blue Hands', kind: 'image', src: '/assets/home/painting-blue-hands.jpg', width: 306, height: 380 },
      { id: 'i-love-mommy', label: 'I Love Mommy', kind: 'image', src: '/assets/home/painting-i-love-mommy.jpg', width: 380, height: 238 },
    ],
  },
  {
    id: 'sprint',
    ...
    items: [
      ...
      { id: 'hifi-frames', label: 'Hi-Fi Frames', kind: 'image', src: '/assets/sprint/hifi-frames.png', width: 380, height: 313 },
      { id: 'app-mockup', label: 'App Mockup', kind: 'image', src: '/assets/shared/sprint-app-mockup.png', width: 380, height: 275 },
      {
        id: 'writeup',
        label: 'Writeup',
        kind: 'text',
  ...
  },
  {
    ...
    link: 'https://www.tavi.kim/',
    items: [
      { id: 'cover', label: 'Slowly · 천천히', kind: 'image', src: '/assets/home/poster-slowly-cloud.png', width: 380, height: 269 },
